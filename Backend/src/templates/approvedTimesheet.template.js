        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background-color:#FFFFFF;border-radius:12px;border:1px solid #D0D7DE;box-shadow:0 1px 3px rgba(27,31,35,0.04),0 8px 24px rgba(27,31,35,0.06);">
          ...
          <tr>
            <td style="padding:0 36px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:20px 0 0 0;">
                    ...
                    <p style="margin:8px 0 0 0;font-size:16px;color:#64748B;line-height:1.7;">Great news! Your weekly timesheet has been approved.</p>
                  </td>
                </tr>
              </table>
              <!-- SUMMARY -->
                  ...
                  <td style="padding:0;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="25%" style="padding:20px 12px;text-align:center;vertical-align:top;border-right:1px solid #E2E8F0;">
                          <span style="font-size:11px;color:#64748B;display:block;line-height:1.4;text-transform:uppercase;letter-spacing:0.5px;font-weight:600;">Approved By</span>
                          <span style="font-size:13px;font-weight:700;color:#0F172A;display:block;line-height:1.4;margin-top:8px;">${managerName}</span>
                        </td>
                        <td width="25%" style="padding:20px 12px;text-align:center;vertical-align:top;border-right:1px solid #E2E8F0;">
                          <span style="font-size:11px;color:#64748B;display:block;line-height:1.4;text-transform:uppercase;letter-spacing:0.5px;font-weight:600;">Approved On</span>
                          <span style="font-size:13px;font-weight:700;color:#0F172A;display:block;line-height:1.4;margin-top:8px;">${formatDate(approvalDate)}</span>
                        </td>
              ...
              ${comment ? `
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:28px 0 0 0;background-color:#F0FFF4;border:1px solid #BBF7D0;border-radius:10px;">
                <tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="32" style="vertical-align:top;padding:0 14px 0 0;">
                          <table cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" style="background-color:#DCFCE7;border-radius:50%;width:32px;height:32px;">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M21 15C21 15.5304 20.7893 16.0391 20.4142 16.4142C20.0391 16.7893 19.5304 17 19 17H7L3 21V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H19C19.5304 3 20.0391 3.21071 20.4142 3.58579C20.7893 3.96086 21 4.46957 21 5V15Z" stroke="#16A34A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                              </td>
                            </tr>
                          </table>
                        ...
                        <td style="vertical-align:top;">
                          <p style="margin:0;font-size:12px;font-weight:700;color:#15803D;letter-spacing:0.4px;text-transform:uppercase;">Message from ${managerName}</p>
                          <p style="margin:8px 0 0 0;font-size:14px;color:#166534;line-height:1.6;">${comment}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
                    ...
                    <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                      <tr>
                        <td align="center" style="background-color:#16A34A;border-radius:8px;">
                          <a href="#" style="display:inline-block;width:280px;padding:14px 0;font-size:15px;font-weight:600;color:#FFFFFF;text-decoration:none;border-radius:8px;background-color:#16A34A;text-align:center;">View Timesheet &rarr;</a>
                        </td>
                      </tr>
                    </table>
                  </td>
