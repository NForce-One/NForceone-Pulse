          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <div className="flex justify-center gap-4 text-sm text-[#a1a1aa] mb-6 flex-wrap">
                <span className="glass-card px-3 py-1 rounded-lg">Client: {timer.Client?.name || form.client || "-"}</span>
                <span className="glass-card px-3 py-1 rounded-lg">Project: {timer.Project?.name || form.project || "-"}</span>
                <span className="glass-card px-3 py-1 rounded-lg">Task: {timer.Task?.title || form.task || "-"}</span>
              </div>
              {timer.description && (
