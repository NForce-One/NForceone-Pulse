...
export const seedDemoData = async (req, res) => {
  try {
    ...
    const taskData = [
      ...
      { title: "Push Notifications",       cat: "Mobile",       pi: 0, bill: true,  assignIdx: 0 },
      { title: "Invoice Engine",           cat: "Development",  pi: 1, bill: true,  assignIdx: 1 },
      { title: "Payment Gateway",          cat: "Integration",  pi: 1, bill: true,  assignIdx: 4 },
      { title: "Client Dashboard",         cat: "Development",  pi: 1, bill: true,  assignIdx: 2 },
      { title: "Call Routing Engine",      cat: "Development",  pi: 2, bill: true,  assignIdx: 1 },
      { title: "Speech Recognition",       cat: "AI/ML",        pi: 2, bill: true,  assignIdx: 4 },
      { title: "IVR Menu Builder",         cat: "Design",       pi: 2, bill: true,  assignIdx: 2 },
    ];
    ...
    // Build uid → managerId map
    const uidToMgr = {};
    empIds.forEach((uid, i) => { uidToMgr[uid] = empData[i].mgr; });

    // ════════════════════════════════════════════
    //  TIME ENTRIES — last 6 weeks with variety
    // ════════════════════════════════════════════
