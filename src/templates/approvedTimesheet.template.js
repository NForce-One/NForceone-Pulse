...
export const approvedTimesheetTemplate = ({
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background-color:#FFFFFF;border-radius:12px;border:1px solid #D0D7DE;box-shadow:0 1px 3px rgba(27,31,35,0.04),0 8px 24px rgba(27,31,35,0.06);">
          <tr>
            <td style="padding:0;">
                            ...
                            <tr>
                              <td style="vertical-align:middle;">
                                <svg width="32" height="32" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect width="28" height="28" rx="6" fill="#2DA44E"/>
                                  <path d="M20 8L11 18L7 14" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                              </td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#2DA44E;height:4px;">
                <tr>
          ...
          <tr>
            <td style="padding:0 36px;">
                ...
                <tr>
                  <td style="padding:48px 0 16px 0;text-align:center;">
                    <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                      <tr>
                        <td align="center" style="background-color:#E6FFEC;border-radius:50%;width:88px;height:88px;">
                          <svg width="44" height="44" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20 6L9 17L4 12" stroke="#1A7F37" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                          </svg>
                        </td>
                      </tr>
                    </table>
                    <h1 style="margin:24px 0 0 0;font-size:30px;font-weight:800;color:#111827;letter-spacing:-0.5px;line-height:1.3;">
                      ...
                      <span style="color:#1A7F37;">APPROVED!</span>
                    </h1>
                  </td>
                </tr>
              </table>
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:16px 0 0 0;">
                    ...
                    <p style="margin:10px 0 0 0;font-size:16px;color:#6B7280;line-height:1.6;">Great news! Your weekly timesheet has been approved.</p>
                  </td>
                </tr>
              </table>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="25%" style="padding:0 8px 0 0;vertical-align:top;text-align:center;">
                          ...
                          <span style="font-size:11px;color:#6B7280;display:block;line-height:1.4;text-transform:uppercase;letter-spacing:0.3px;">Approved By</span>
                        ...
                        <td width="25%" style="padding:0 8px 0 0;vertical-align:top;text-align:center;">
                          ...
                          <span style="font-size:11px;color:#6B7280;display:block;line-height:1.4;text-transform:uppercase;letter-spacing:0.3px;">Approved On</span>
                          <span style="font-size:13px;font-weight:600;color:#111827;display:block;line-height:1.4;margin-top:4px;">${formatDate(approvalDate)}</span>
                        </td>
              ...
              ${comment ? `
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:28px 0 0 0;background-color:#F0FFF4;border:1px solid #B8F0C1;border-radius:10px;">
                <tr>
                      ...
                      <tr>
                        <td width="28" style="vertical-align:top;padding:2px 14px 0 0;">
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21 15C21 15.5304 20.7893 16.0391 20.4142 16.4142C20.0391 16.7893 19.5304 17 19 17H7L3 21V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H19C19.5304 3 20.0391 3.21071 20.4142 3.58579C20.7893 3.96086 21 4.46957 21 5V15Z" stroke="#1A7F37" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                          </svg>
                        </td>
                        <td style="vertical-align:top;">
                          <p style="margin:0;font-size:13px;font-weight:700;color:#1A7F37;letter-spacing:0.3px;text-transform:uppercase;">Message from ${managerName}</p>
                          <p style="margin:8px 0 0 0;font-size:14px;color:#1B3D2A;line-height:1.6;">${comment}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:36px 0 0 0;">
                <tr>
                  <td align="center">
                    <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                      <tr>
                        <td align="center" style="background-color:#1A7F37;border-radius:8px;">
                          <a href="#" style="display:inline-block;width:280px;padding:14px 0;font-size:15px;font-weight:600;color:#FFFFFF;text-decoration:none;border-radius:8px;background-color:#1A7F37;text-align:center;">View Timesheet &rarr;</a>
                        </td>
                      </tr>
                    </table>
                  </td>
